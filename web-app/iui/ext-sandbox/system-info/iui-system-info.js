/*
   ...
   ************
   LAST UDPATE: Oct 31th, 2010 - remi.grumeau@gmail.com
   ************
*/
...
iui.sysinfo = {
	...
	osInfo : function()
	{
		if(iui.sysinfo.ua.match('iphone') || iui.sysinfo.ua.match('ipad')) {
			iui.sysinfo.os.name	= 'iphoneos';
			...
			iui.sysinfo.os.name	= 'windows';
	
			if(iui.sysinfo.ua.match('nt 5.1'))
	...
	deviceInfo: function() 
	{
		iui.sysinfo.device.touch = (typeof Touch == "object");
	...
	{
		iui.sysinfo.browser.webapp = (window.navigator.standalone==1)?'true':'false';
		...
		else if(iui.sysinfo.ua.match('applewebkit') || (iui.sysinfo.ua.match('iphone')) || (iui.sysinfo.ua.match('safari'))) 
		{
		...
		iui.sysinfo.browser.standalone = (window.navigator.standalone===true)?'true':'false';
